...
/**
 * Configuration of bbcode processor. It's thread safe class.
 * 
...
public class Configuration implements TextProcessorFactory
{
    ...
    /**
     * Add param with name <code>name</code> and value <code>value</code> to
     * root context. Call addParam(String, object)
     * 
     * @param name
