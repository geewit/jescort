...
import net.gelif.modules.bbcode.configuration.*;
...
public class DomConfigurationFactory
{
     ...
     * Schema location
     */
    private static final String SCHEMA_LOCATION = "http://www.gelif.net/schemas/bbcode";
    /**
    ...
    private Map<String, Scope> parseScopes(NodeList scopeNodeList)
    {
        ...
        for(int i = 0; i < scopeNodeList.getLength(); i++)
        {
            ...
            Scope scope = new Scope(name, nodeAttribute(scopeElement, TAG_SCOPE_ATTR_PARENT, null), nodeAttribute(scopeElement, TAG_SCOPE_ATTR_IGNORE_TEXT, DEFAULT_IGNORE_TEXT));
