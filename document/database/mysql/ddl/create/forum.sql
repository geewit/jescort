...
CREATE TABLE drafts (
    ...
    PRIMARY KEY  (id),
    INDEX draft_user_id_idx (user_id)
) ENGINE=InnoDB CHARSET=utf8;
...
CREATE TABLE forums (
    ...
    createdate             DATETIME             NOT NULL,
    PRIMARY KEY  (id),
    INDEX forum_category_id_idx (category_id),
    INDEX forum_last_post_id_idx (last_post_id)
) ENGINE=InnoDB CHARSET=utf8;
...
CREATE TABLE posts (
    ...
    status               INT                    NOT NULL,
    PRIMARY KEY  (id),
    INDEX post_poster_id_idx (poster_id),
    INDEX post_topic_id_idx (topic_id)
) ENGINE=InnoDB CHARSET=utf8;
...
CREATE TABLE post_edits (
    ...
    PRIMARY KEY (id),
    INDEX post_editor_id_idx (editor_id)
) ENGINE=InnoDB CHARSET=utf8;
...
CREATE TABLE topics (
    ...
    createdate          DATETIME                NOT NULL,
    PRIMARY KEY  (id),
    INDEX topic_forum_id_idx (forum_id),
    INDEX topic_root_post_id_idx (root_post_id),
    INDEX topic_last_post_id_idx (last_post_id)
) ENGINE=InnoDB CHARSET=utf8;
