...
<div id="breadcrumb">
    <ul class="fleft">
        ...
        <li>
            <a title="Return to Help &amp; Discussion Center" href="forum/118"> Help &amp; Discussion Center </a>
        </li>
        <li>
            <b> <a title="Return to Hardware Hangout" href="forum/13"> Hardware Hangout </a> </b>
        </li>
    </ul>
                ...
                <fieldset>
                    ...
                    <ul>
                        <li class="field">
                            ...
                            <textarea id="bbcode" name="rootPost.content" type="text"> ${topic.rootPost.content} </textarea>
                        </li>
                    </ul>
                </fieldset>
                <fieldset class="attachments">
                    ...
                    <div style="margin: 15px 15px 0 15px" class="message unspecific">
                        ...
                        <p id="help_msg" class="desc">
                            <a tabindex="1" title="" href="forum/index.php"> Try our advanced uploader which supports multiple file uploading (modern browser required) </a>
                        </p>
                    </div>
                </fieldset>
