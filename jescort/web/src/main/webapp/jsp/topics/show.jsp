...
<div id="content">
    <div style="margin-top:10px" class="topic_controls">
        ...
        <ul class="topic_buttons">
            ...
            <li class="disabled"><spring:message code="message.topic_cannot_replied"/></li>
                    ...
                    <shiro:authenticated>
            <li><a accesskey="r" title="Add Reply" href="<spring:url value="/topics/${topic.id}/reply"/>"><img alt="Add Reply" src="<spring:url value="/static/images/arrow_rotate_clockwise.png"/>"><spring:message code="message.post_reply"/></a></li>
                    </shiro:authenticated>
                </c:otherwise>
            </c:choose>
        </ul>
    ...
    <div class="topic hfeed">
        ...
        <div class="block-forum rounded-bot">
                ...
                <div class="post_wrap">
                    <h3>
                        <div class="post-author">
                            <span class="user-status"></span> &nbsp; <span class="author vcard">
                                ...
                                <a href="<spring:url value="/users/${poster.id}"/>" class="url fn">${poster.username}</a>&nbsp; <a title="View Profile" class="__user" href="<spring:url value="/users/${poster.id}"/>">
                                    <img alt="" src="<spring:url value="/static/images/user_popup.png"/>">
                                </a>
                            </span>
                        </div>
                    ...
                    <div class="author_info">
                        <ul style="margin-bottom:0" class="user_details">
                            <li class="avatar"><a title="View Profile" href="<spring:url value="/users/${poster.id}"/>"><img height="68" width="90" alt="" src="${poster.profile.photo}"></a></li>
                        ...
                        <ul class="user_fields">
                            ...
                            <li>
                                <span class="ft"><spring:message code="message.author_location"/>:</span><span class="fc">${poster.mainAddress.location.name}</span>
                            </li>
                        </ul>
                    </div>
                    <div class="post_body">
            ...
            <c:if test="${!status.last}"><div class="post-sep"></div></c:if>
            </c:forEach>
            </c:if>
        </div>
        <!-- THREADED MODE -->
                        ...
                        <td align="right" style="width:33%">
                            <ul class="topic_buttons">
                                ...
                                <li class="disabled"><spring:message code="message.topic_cannot_replied"/></li>
                                        ...
                                        <shiro:authenticated>
                                <li><a accesskey="r" title="Add Reply" href="<spring:url value="/topics/${topic.id}/reply"/>"><img alt="Add Reply" src="<spring:url value="/static/images/arrow_rotate_clockwise.png"/>">Add Reply</a></li>
                                        </shiro:authenticated>
                                    </c:otherwise>
                                </c:choose>
                            </ul>
        ...
        <div class="moderation_bar rounded" style="background:transparent; padding-left: 0; padding-right: 0;">
		</div>
    </div>
    <div class="clear"></div>
</div>