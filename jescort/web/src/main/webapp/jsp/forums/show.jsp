...
<div id="content">
    ...
    <div style="padding-top: 0;" class="category_block block_wrap clear">
        <h3 class="maintitle"> ${forum.subject} </h3>
                    ...
                    <c:forEach var="topic" items="${topics.content}" varStatus="status">
                        <tr id="trow_${topic.id}" class="row${status.index % 2 + 1}">
                            <td class="short altrow">
                                <img alt="Hot Topic (New)" src="<spring:url value="/static/images/t_hot_unread.png"/>">
                            </td>
                            ...
                            <td class="short desc">
                                <a href="<spring:url value="/"/>" class="___hover___member _hoversetup" id="anonymous_element_${status.count}" title="">${topic.rootPost.poster.username}</a>&nbsp;<a title="View Profile" class="__user" href="<spring:url value="/"/>"><img alt="" src="<spring:url value="/static/images/user_popup.png"/>"></a>
                            </td>
                            <td class="desc stats">
                                <ul>
                                    <li>
