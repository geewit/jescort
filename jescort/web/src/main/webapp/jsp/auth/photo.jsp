                ...
                <form id="userCPForm" action="<spring:url value="/"/>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="border row1 rounded-bot clearfix">
                        <ul class="tab_bar no_title">
                            <li><a title="Settings for Settings" href="http://www.neowin.net/forum/index.php?app=core&amp;module=usercp&amp;tab=core">Settings</a></li>
                            <li class="active"><a title="Settings for Profile" href="http://www.neowin.net/forum/index.php?app=core&amp;module=usercp&amp;tab=members">Profile</a></li>
                        </ul>
                        <div class="tab_body usercp_body">
                            ...
                            <div id="usercp_content">
                                ...
                                <fieldset class="row2">
                                    ...
                                    <div align="center">
                                        <p><img width="150" height="150" alt="Your Personal Photo" src="<spring:url value="/"/>"><br>(150 x 150)</p>
                                ...
                                <fieldset class="row1">
                                    ...
                                    <ul>
                                        <li class="field">
                                            ...
                                            <p><strong>Image Scale On</strong><br>(This will scale the image down for you if it's too big in pixel size)</p>
                                        </li>
                                    </ul>
                                </fieldset>
