        ...
        <div class="border row1 rounded-bot clearfix">
            ...
            <div class="tab_body usercp_body">
                ...
                <div id="usercp_content">
                    <fieldset class="row1">
                        <h3>Change Display Name</h3><br>

                        <p class="message unspecific">You have made 0 of 2 display name changes since 23 May 2011.<br>You are permitted to make 2 changes in a 90 day period.<br><br>Changing your display name will
                            <strong>not</strong> affect your log in details.</p>

                        <ul>
                            <li class="field">
                                <label for="displayName">Enter a new display name</label><input type="text" size="30" value="" id="displayName" name="displayName" maxlength="26" class="input_text">
                                <br>

                                <span class="desc">This is the display name you wish to now use. Characters not permitted: [ ] | , ; $</span>
                            </li>
                            <li class="field">
                                <label for="displayPassword">Enter your current password</label><input type="password" size="30" value="" id="displayPassword" name="displayPassword" class="input_text">
                                <br>
