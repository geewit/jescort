...
<div id="content">
    ...
    <p class="message unspecific">
        ...
        Enter your username or email address in the field below. The username or email address is case <b>in</b>sensitive.<br>Once
     you have submitted the form, you will receive an email asking for
    validation of this request to ensure that no malicious use has occurred.
     This email will also contain a link that you must click for further
    instruction.
    </p>
