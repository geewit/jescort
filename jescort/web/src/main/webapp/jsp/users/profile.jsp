...
<div id="breadcrumb">
    ...
    <ul class="fright" id="breadcrumb-links">
        <li style="padding-right:0"><a href="<spring:url value="/rules"/>" class="button small"><spring:message code="message.forum_rules"/></a></li>
    </ul>
    <div class="clear"></div>
</div>
<!-- // Breadcrumb -->
<div id="content">
	<ul class="topic_buttons">
		<li><a href="http://www.neowin.net/forum/index.php?app=core&module=usercp&tab=members"><img src="<spring:url value="/static/images/user_edit.png"/>" alt="Edit"> Edit my Profile</a></li>
	</ul>
					...
					<div class="general_box alt rounded">
						<h3 class="rounded-top">Member Photo</h3>
							<div class="personal_info clear">
								...
								<ul>
									<li><a href="<spring:url value="/"/>"><img src="<spring:url value="/static/images/page_topic_magnify.png"/>" alt="Find Topics"> Find My Content</a></li>
									<li id="dname_history"><a href="<spring:url value="/"/>" title="View display name history"><img src="<spring:url value="/static/images/display_name.png"/>" alt=""> Display name history</a></li>
								</ul>
							</div>
							...
							<div class="other_contact"><div class="about_info">
								<dl>
									<dt>Group:</dt>
									...
									<dt>Joined:</dt>
									<dd><fmt:formatDate value="${user.createdate.time}" type="both" pattern="yyyy-MM-dd HH:mm"/></dd>
									<dt>Last Active:</dt>
									<dd><img title="User is offline" alt="User is offline" src="<spring:url value="/static/images/user_off.gif"/>"><fmt:formatDate value="${user.lastActive.time}" type="both" pattern="yyyy-MM-dd HH:mm"/></dd>
								</dl>
							</div>
						</div>
						<div class="other_contact clearfix clear">
							<div class="about_info">
								...
								<dl>
									...
									<dt>Birthday:</dt>
									<dd><fmt:formatDate value="${user.profile.birthday.time}" type="both" pattern="yyyy-MM-dd"/></dd>
									<dt>Gender:</dt>
									<dd>
                                        <c:choose>
                                            <c:when test="${not empty user.profile.gender}">
				...
				<div class="block-forum rounded-bot clearfix">
					<div class="recent_activity">
						<ol class="tab_bar no_title mini">
							<li id="tab_link_members:status" class="tab_toggle active"><a href="<spring:url value="/"/>" title="View Recent Status Updates">Recent Status Updates</a></li>
							<li id="tab_link_members:aboutme" class="tab_toggle "><a href="<spring:url value="/"/>" title="View About Me">About Me</a></li>
							<li id="tab_link_forums:topics" class="tab_toggle "><a href="<spring:url value="/"/>" title="View Topics">Topics</a></li>
							<li id="tab_link_forums:posts" class="tab_toggle "><a href="<spring:url value="/"/>" title="View Posts">Posts</a></li>
						</ol>
