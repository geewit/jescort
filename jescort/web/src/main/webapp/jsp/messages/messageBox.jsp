...
<div id="content">
    ...
    <div class="right" id="messenger_content">
                    ...
                    <table id="message_table" class="ipb_table">
                        <tbody>
                            <tr class="header">
                                ...
                                <th class="col_mod short" scope="col"><input type="checkbox" value="1" id="msg_checkall" class="input_check"></th>
                            </tr>
                            ...
                            <tr class="row${status.index % 2 + 1}" id="${message.id}">
                                ...
                                <td>
                                    <ul class="last_post">
                                        <li><fmt:formatDate value="${message.createdate.time}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></li>
                                    </ul>
                                </td>
                                <td class="short">
        ...
        <div class="topic_controls">
            <jescort:pager page="${messageBox}" requestUrl="/messages"/>
            <ul class="topic_buttons">
                <li><a title="Go to compose screen" href="<spring:url value="/messages/new"/>"><img alt="Compose" src="<spring:url value="/static/images/note_add.png"/>"> Compose New</a></li>
            </ul>
        </div>
    </div>
    <!-- end -->
