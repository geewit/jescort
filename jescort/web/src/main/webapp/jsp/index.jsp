                        ...
                        <div class="table_wrap">
                            <table cellspacing="0" class="ipb_table" summary="Forums within the category '${category.subject}'">
                                ...
                                <tr class="header">
                                    ...
                                    <th scope="col" class="col_c_post">
                                        <spring:message code="message.last_post_info"/></th>
                                    <th style="width: 1%;"></th>
                                </tr>
                                <!-- / CAT HEADER -->
                                <c:if test="${not empty category.forums}">
                                    <c:forEach var="forum" items="${category.forums}" varStatus="forumStatus">
                                        ...
                                        <tr class="row${forumStatus.index % 2 + 1} forum-row">
                                            ...
                                            <td>
                                                <a href="${topicUrl}" title="View last post"><img src="<spring:url value="/static/images/last_post.png"/>" alt="" title="View last post"></a>
                                            </td>
                                        </tr>
                                    </c:forEach></c:if>
                                </tbody>
